...
# Buscando por mensagens que contenham "comprovante" hoje
msgs = make_request(f"whatsapp_chat?message=ilike.%25comprovante%25&created_at=gte.2026-02-11T00:00:00&order=created_at.asc")

print(f"Mensagens com 'comprovante' hoje:")
for m in msgs:
